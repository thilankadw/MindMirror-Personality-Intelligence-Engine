"""Training pipeline for agreeableness."""
import os
import json
...
from pipelines.personality.agreeableness.data_pipeline import data_pipeline
...
def training_pipeline(
	...
	run_tags = create_mlflow_run_tags(
		'train_pipeline', {
			...
			'num_targets': '1',
			'target_traits': ','.join(get_target_features(domain=DOMAIN, trait=TRAIT))
		}
	)
